...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/utils/findBoxHorizontalPosition.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = findBoxHorizontalPosition;
function findBoxHorizontalPosition(_ref) {
  var matrix = _ref.matrix,
    startCondition = _ref.startCondition,
    x = _ref.x,
    y = _ref.y,
    changeMethod = _ref.changeMethod,
    endCondition = _ref.endCondition,
    box = _ref.box;
  if (startCondition(x)) return;
  var boxLine = matrix[y];
  var currentX = x;
  var foundX = x;
  do {
    currentX = changeMethod(currentX);
    var anotherBox = boxLine[currentX];
    if (anotherBox) {
...
},{}],"src/utils/findBoxVerticalPosition.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = findBoxVeticalPosition;
function findBoxVeticalPosition(_ref) {
  var matrix = _ref.matrix,
    startCondition = _ref.startCondition,
    x = _ref.x,
    y = _ref.y,
  ...
  var matrixColumn = matrix.map(function (matrixLine) {
    return matrixLine[x];
  });
  var currentY = y;
  var foundY = y;
  do {
    ...
    var anotherBox = matrixColumn[currentY];
    if (anotherBox) {
      if (anotherBox.getValue() === box.getValue()) {
        foundY = currentY;
        box.mergeBoxValue();
...
},{}],"src/utils/generateRandom.js":[function(require,module,exports) {
"use strict";
...
exports.addBoxToMatrix = addBoxToMatrix;
exports.changeMatrixBoxPosition = changeMatrixBoxPosition;
exports.default = getMatrix;
exports.getEmptyMatrixCoordinates = getEmptyMatrixCoordinates;
...
function getEmptyMatrixCoordinates() {
  return matrix.reduce(function (emptyCoordinates, matrixLine, y) {
    matrixLine.forEach(function (elem, x) {
      if (!elem) {
...
function addBoxToMatrix(box) {
  var _box$getPosition = box.getPosition(),
    x = _box$getPosition.x,
    y = _box$getPosition.y;
  matrix[y][x] = box;
}
function changeMatrixBoxPosition(box) {
  var boxId = box.id;
  var _box$getPosition2 = box.getPosition(),
    x = _box$getPosition2.x,
    y = _box$getPosition2.y;
  var oldBoxPosition = null;
  matrix.forEach(function (matrixLine, matrixY) {
    return matrixLine.forEach(function (matrixElem, matrixX) {
...
},{}],"src/utils/createBox.js":[function(require,module,exports) {
"use strict";
...
var _findBoxHorizontalPosition = _interopRequireDefault(require("./findBoxHorizontalPosition"));
var _findBoxVerticalPosition = _interopRequireDefault(require("./findBoxVerticalPosition"));
var _generateRandom = _interopRequireDefault(require("./generateRandom"));
...
function getBoxPosition() {
  var emptyCoordinates = (0, _matrix.getEmptyMatrixCoordinates)();
  var randomCoordinateIndex = (0, _generateRandom.default)(0, emptyCoordinates.length - 1);
...
var Box = /*#__PURE__*/function () {
  function Box() {
    ...
    this.id = (0, _generateRandom.default)(1, 99999999999);
    this.value = getValue();
  ...
  _createClass(Box, [{
    key: "setBoxPosition",
    value: function setBoxPosition(newPosition) {
    ...
    key: "changeBoxPosition",
    value: function changeBoxPosition() {
      var boxX = this.position.x * 25;
      var boxY = this.position.y * 25;
      this.boxElem.style.top = "".concat(boxY, "%");
      this.boxElem.style.left = "".concat(boxX, "%");
    }
  }, {
    key: "getPosition",
    ...
    value: function kill() {
      var _this = this;
      setTimeout(function () {
        _this.boxElem.remove();
      }, 100);
    }
  }, {
    key: "setBoxValue",
    value: function setBoxValue() {
      var shouldAddClass = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      this.boxElem.innerHTML = this.value;
      this.boxElem.classList.remove("number_".concat(this.value / 2));
      if (shouldAddClass) {
        this.boxElem.classList.add("number_".concat(this.value));
      }
    }
  }, {
    key: "mergeBoxValue",
    value: function mergeBoxValue() {
      var _this2 = this;
      this.value = this.value * 2;
      var shouldAddClass = this.value <= 2048;
      setTimeout(function () {
        _this2.setBoxValue(shouldAddClass);
      }, 100);
    }
  }, {
    key: "move",
    value: function move(moveDirection) {
      //left, up, right, down
      var matrix = (0, _matrix.default)();
      ...
      switch (moveDirection) {
        case "left":
          {
            (0, _findBoxHorizontalPosition.default)({
              box: this,
              x: x,
              y: y,
              matrix: matrix,
              startCondition: function startCondition(x) {
                return !x;
              },
              endCondition: function endCondition(currentX) {
                return currentX > 0;
              },
              changeMethod: function changeMethod(currentX) {
                return currentX - 1;
              }
            });
            break;
        ...
        case "up":
          {
            (0, _findBoxVerticalPosition.default)({
              box: this,
              x: x,
              y: y,
              matrix: matrix,
              startCondition: function startCondition(y) {
                return !y;
              },
              endCondition: function endCondition(currentY) {
                return currentY > 0;
              },
              changeMethod: function changeMethod(currentY) {
                return currentY - 1;
              }
            });
            break;
      ...
      (0, _matrix.changeMatrixBoxPosition)(this);
    }
  }, {
    key: "setBoxToScreen",
    value: function setBoxToScreen() {
      var matrixElem = document.getElementById("matrix");
      this.changeBoxPosition();
      this.setBoxValue();
      (0, _matrix.addBoxToMatrix)(this);
...
},{"./findBoxHorizontalPosition":"src/utils/findBoxHorizontalPosition.js","./findBoxVerticalPosition":"src/utils/findBoxVerticalPosition.js","./generateRandom":"src/utils/generateRandom.js","./matrix":"src/utils/matrix.js"}],"node_modules/lodash/_listCacheClear.js":[function(require,module,exports) {
/**
...
},{"./_baseIsEqual":"node_modules/lodash/_baseIsEqual.js"}],"src/utils/gameOver.js":[function(require,module,exports) {
"use strict";
...
var isAllowedMatrixElem = function isAllowedMatrixElem(box) {
  return function (matrixElem) {
    return typeof matrixElem !== "undefined" && (matrixElem === 0 || (matrixElem === null || matrixElem === void 0 ? void 0 : matrixElem.getValue()) === (box === null || box === void 0 ? void 0 : box.getValue()));
  };
};
function gameOver(matrix) {
  var isGameOver = !matrix.some(function (matrixLine, y) {
    return matrixLine.some(function (matrixElem, x) {
      var _matrix$y, _matrix$y2, _matrix, _matrix2;
      var leftElem = (_matrix$y = matrix[y]) === null || _matrix$y === void 0 ? void 0 : _matrix$y[x - 1];
      var rightElem = (_matrix$y2 = matrix[y]) === null || _matrix$y2 === void 0 ? void 0 : _matrix$y2[x + 1];
      var upElem = (_matrix = matrix[y - 1]) === null || _matrix === void 0 ? void 0 : _matrix[x];
      var downElem = (_matrix2 = matrix[y + 1]) === null || _matrix2 === void 0 ? void 0 : _matrix2[x];
      var canBeMoved = matrixElem ? [leftElem, rightElem, upElem, downElem].some(isAllowedMatrixElem(matrixElem)) : true;
      return canBeMoved;
    });
  });
  return isGameOver;
}
},{}],"src/utils/moveMatricsElements.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = moveMatrixElements;
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function moveMatrixElements(moveDirection) {
  // left, up, right, down
  var matrix = (0, _matrix.default)();
  var oldMatrix = (0, _cloneDeep.default)(matrix);
  if (moveDirection === "left") {
    var _loop = function _loop(index) {
      matrix.forEach(function (matrixLine) {
        var box = matrixLine[index];
        if (box) {
    ...
    var _loop2 = function _loop2(_index) {
      matrix.forEach(function (matrixLine) {
        var box = matrixLine[_index];
        if (box) {
          box.move(moveDirection);
        }
      });
    };
    for (var _index = matrix.length - 2; _index > -1; _index--) {
      _loop2(_index);
    }
    ...
    for (var _index2 = matrix.length - 2; _index2 > -1; _index2--) {
      matrix[_index2].forEach(function (box) {
        if (box) {
          box.move(moveDirection);
        }
      });
  ...
  var isSameMatrix = (0, _isEqual.default)(oldMatrix, matrix);
  if (!isSameMatrix) {
    (0, _createBox.default)();
    var isGameOver = (0, _gameOver.default)(matrix);
    if (isGameOver) {
...
},{"./createBox":"src/utils/createBox.js","./matrix":"src/utils/matrix.js","lodash/cloneDeep":"node_modules/lodash/cloneDeep.js","lodash/isEqual":"node_modules/lodash/isEqual.js","./gameOver":"src/utils/gameOver.js"}],"src/utils/listeners.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = createListeners;
var _moveMatricsElements = _interopRequireDefault(require("./moveMatricsElements"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var listeners = {
  37: "left",
  38: "up",
...
function createListeners() {
  document.addEventListener("keydown", function (event) {
    (0, _moveMatricsElements.default)(listeners[event.keyCode]);
  });
}
},{"./moveMatricsElements":"src/utils/moveMatricsElements.js"}],"src/index.js":[function(require,module,exports) {
"use strict";

var _createBox = _interopRequireDefault(require("./utils/createBox"));
var _listeners = _interopRequireDefault(require("./utils/listeners"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function startGame() {
...
startGame();
},{"./utils/createBox":"src/utils/createBox.js","./utils/listeners":"src/utils/listeners.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
